...
from custom_maschine.util import LatchingBehaviour
...
def create_mappings(surface):
    ...
    mappings["Group_Button_Modes"] = dict(
        default = dict(
            ...
            matrix = "upper_half_pads_with_group",
        ),
        keyboard = dict(
            component = "Maschine_Playable",
            octave_select_buttons = "upper_half_pads_with_group",
        ),
        drum_rack = dict(
            component = "Drum_Group",
            select_buttons = "upper_half_pads_with_group",
        ),
        simpler = dict(
        ...
        step = dict(
            component = "Step_Sequence",
            loop_buttons = "upper_half_pads_with_group",
        ),
        note_repeat = dict(
            component = "Note_Repeat",
            rate_select_buttons = "upper_half_pads_with_group",
        ),
    )
