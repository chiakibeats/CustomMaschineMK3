...
from .elements import MaschineMikroMK3Elements
...
class CustomMaschineMikroMK3Spec(CustomMaschineBaseSpec):
    elements_type = MaschineMikroMK3Elements
...
def init_specification(settings):
    ...
    """
    spec = CustomMaschineMikroMK3Spec
