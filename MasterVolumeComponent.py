...
from ableton.v3.base import clamp, sign, listens
...
class MasterVolumeComponent(Component):
    ...
    def __init__(self, name = "MasterVolume", *a, **k):
        super().__init__(name, *a, **k)

    # roughly 1dB / 0.1dB step gain control
    @coarse_volume.value
    def _on_coarse_volume_changed(self, value, encoder):
        volume_parameter = self.song.view.selected_track.mixer_device.volume
